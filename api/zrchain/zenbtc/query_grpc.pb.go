...
const (
	Query_Params_FullMethodName                      = "/zrchain.zenbtc.Query/Params"
	Query_LockTransactions_FullMethodName            = "/zrchain.zenbtc.Query/LockTransactions"
	Query_ConfirmedUnlockTransactions_FullMethodName = "/zrchain.zenbtc.Query/ConfirmedUnlockTransactions"
)
...
func (c *queryClient) LockTransactions(ctx context.Context, in *QueryLockTransactionsRequest, opts ...grpc.CallOption) (*QueryLockTransactionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_LockTransactions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ConfirmedUnlockTransactions(ctx context.Context, in *QueryConfirmedUnlockTransactionsRequest, opts ...grpc.CallOption) (*QueryConfirmedUnlockTransactionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ConfirmedUnlockTransactions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_ConfirmedUnlockTransactions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_ConfirmedUnlockTransactions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
