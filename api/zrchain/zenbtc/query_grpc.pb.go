...
const (
	Query_GetParams_FullMethodName                    = "/zrchain.zenbtc.Query/GetParams"
	Query_LockTransactions_FullMethodName             = "/zrchain.zenbtc.Query/LockTransactions"
...
func (c *queryClient) LockTransactions(ctx context.Context, in *QueryLockTransactionsRequest, opts ...grpc.CallOption) (*QueryLockTransactionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_LockTransactions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetRedemptions(ctx context.Context, in *QueryRedemptionsRequest, opts ...grpc.CallOption) (*QueryRedemptionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetRedemptions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryPendingMintTransactions(ctx context.Context, in *QueryPendingMintTransactionsRequest, opts ...grpc.CallOption) (*QueryPendingMintTransactionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_QueryPendingMintTransactions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QuerySupply(ctx context.Context, in *QuerySupplyRequest, opts ...grpc.CallOption) (*QuerySupplyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_QuerySupply_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryBurnEvents(ctx context.Context, in *QueryBurnEventsRequest, opts ...grpc.CallOption) (*QueryBurnEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_QueryBurnEvents_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_LockTransactions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_LockTransactions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
