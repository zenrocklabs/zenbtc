...
var (
	...
	fd_MsgSubmitUnsignedRedemptionTx_outputs protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgSubmitUnsignedRedemptionTx_outputs = md_MsgSubmitUnsignedRedemptionTx.Fields().ByName("outputs")
}
...
func (x *fastReflection_MsgSubmitUnsignedRedemptionTx) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.Outputs != "" {
		value := protoreflect.ValueOfString(x.Outputs)
		if !f(fd_MsgSubmitUnsignedRedemptionTx_outputs, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgSubmitUnsignedRedemptionTx) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "zrchain.zenbtc.MsgSubmitUnsignedRedemptionTx.creator":
		return x.Creator != ""
	case "zrchain.zenbtc.MsgSubmitUnsignedRedemptionTx.outputs":
		return x.Outputs != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgSubmitUnsignedRedemptionTx) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "zrchain.zenbtc.MsgSubmitUnsignedRedemptionTx.creator":
		x.Creator = value.Interface().(string)
	case "zrchain.zenbtc.MsgSubmitUnsignedRedemptionTx.outputs":
		x.Outputs = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.zenbtc.MsgSubmitUnsignedRedemptionTx"))
		}
...
func (x *fastReflection_MsgSubmitUnsignedRedemptionTx) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "zrchain.zenbtc.MsgSubmitUnsignedRedemptionTx.outputs":
		panic(fmt.Errorf("field outputs of message zrchain.zenbtc.MsgSubmitUnsignedRedemptionTx is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: zrchain.zenbtc.MsgSubmitUnsignedRedemptionTx"))
		}
...
func (x *fastReflection_MsgSubmitUnsignedRedemptionTx) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.Outputs) > 0 {
			i -= len(x.Outputs)
			copy(dAtA[i:], x.Outputs)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.Outputs)))
			i--
			dAtA[i] = 0x12
		}
		if len(x.Creator) > 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 2:
				...
				x.Outputs = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
func (x *MsgSubmitUnsignedRedemptionTx) GetOutputs() string {
	if x != nil {
		return x.Outputs
	}
	return ""
...
var file_zrchain_zenbtc_tx_proto_rawDesc = []byte{
	...
	0x61, 0x0a, 0x1d, 0x4d, 0x73, 0x67, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x55, 0x6e, 0x73, 0x69,
	...
	,
	...
	,
...
var file_zrchain_zenbtc_tx_proto_goTypes = []interface{}{
	...
	(*MsgSubmitUnsignedRedemptionTxResponse)(nil),  // 5: zrchain.zenbtc.MsgSubmitUnsignedRedemptionTxResponse
...
var file_zrchain_zenbtc_tx_proto_depIdxs = []int32{
	...
	4, // 3: zrchain.zenbtc.Msg.SubmitUnsignedRedemptionTx:input_type -> zrchain.zenbtc.MsgSubmitUnsignedRedemptionTx
	...
	5, // 6: zrchain.zenbtc.Msg.SubmitUnsignedRedemptionTx:output_type -> zrchain.zenbtc.MsgSubmitUnsignedRedemptionTxResponse
