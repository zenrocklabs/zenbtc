...
func (m *BurnEvents) Reset()         { *m = BurnEvents{} }
func (m *BurnEvents) String() string { return proto.CompactTextString(m) }
func (*BurnEvents) ProtoMessage()    {}
func (*BurnEvents) Descriptor() ([]byte, []int) {
	return fileDescriptor_c558a292253a42cf, []int{3}
}
func (m *BurnEvents) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BurnEvents) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BurnEvents.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BurnEvents) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BurnEvents.Merge(m, src)
}
func (m *BurnEvents) XXX_Size() int {
	return m.Size()
}
func (m *BurnEvents) XXX_DiscardUnknown() {
	xxx_messageInfo_BurnEvents.DiscardUnknown(m)
}

var xxx_messageInfo_BurnEvents proto.InternalMessageInfo

func (m *BurnEvents) GetEvents() []*BurnEvent {
	if m != nil {
		return m.Events
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BurnEvents)(nil), "zrchain.zenbtc.BurnEvents")
}
...
var fileDescriptor_c558a292253a42cf = []byte{
	...
	,
}
...
func (m *BurnEvents) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BurnEvents) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BurnEvents) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BurnEvents) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BurnEvents: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BurnEvents: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Events = append(m.Events, &BurnEvent{})
